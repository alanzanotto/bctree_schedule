...
<div data-role="page" id="data_page">
	...
	<form>
		...
		<a href="#data_page" data-role="button" data-icon="check" data-inline="true" class="show-page-loading-msg" data-textonly="true" data-textvisible="true" data-msgtext="Loading Employees..." onClick="update_data_page_editEmployeeName()">Save</a>
		</br><hr>
